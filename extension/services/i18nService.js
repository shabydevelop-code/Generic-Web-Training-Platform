(() => {
  const translations = Object.freeze({
    en: Object.freeze({
      ...
      resumeElementNotFound: "The required element was not found on the current screen. Open the correct screen and choose Continue learning to try again, or start again.",
    ...
    he: Object.freeze({
      ...
      resumeElementNotFound: "הרכיב הנדרש לא נמצא במסך הנוכחי. עבור למסך המתאים ובחר המשך למידה כדי לנסות שוב, או התחל מחדש.",
